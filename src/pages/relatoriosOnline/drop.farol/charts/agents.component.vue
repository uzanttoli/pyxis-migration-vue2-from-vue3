      ...
      montarGraficos() {
        ...
        for (let i = 0; i < this.dadosFarol.length; i++) {
          data.push({
            ...
            previsto: Math.round(this.dadosFarol[i].recursos),
            realizado: this.realizadoDesempenho(
              this.dadosFarol[i].logado,
              this.dadosFarol[i].pausa
            ),
            produtivos: this.calcularRealizado(
              this.dadosFarol[i].falado,
              this.dadosFarol[i].disponivel,
              this.dadosFarol[i].pos_atendimento,
              this.dadosFarol[i].hold,
              this.dadosFarol[i].tempo_chamada_externa,
              this.dadosFarol[i].tempo_chamada_direta
            )
          })
        }
        chart.data = data
        ...
        createSeries('previsto', 'Agents Prev.')
        createSeries('realizado', 'Agents Real.')
        createSeries('produtivos', 'Agents Prod. NET')
