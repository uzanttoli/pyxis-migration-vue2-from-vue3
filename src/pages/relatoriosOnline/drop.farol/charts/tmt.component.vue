      ...
      montarGraficos() {
        ...
        for (let i = 0; i < this.dadosFarol.length; i++) {
          data.push({
            ...
            tma: this.previstoTMA(this.dadosFarol[i].tma, this.dadosFarol[i].forecast),
            realizado: this.realizadoTMA(
        ...
        createSeries('tma', 'TMT Previsto')
        createSeries('realizado', 'TMT Realizado')
