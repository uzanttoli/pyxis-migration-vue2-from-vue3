    ...
    <v-card class="rounded-xl">
      <v-card-title class="mb-n7">
        <title-negative-margin
          title="Visitas Técnicas | Operadores"
...
<script>
  ...
  export default {
    ...
    name: 'TableGenericsVTOperadores',
    data() {
      return {
        visitas: [],
        search: null,
    ...
    methods: {
      async loadDadosImprodutivosPorOperador() {
        let result = await DadosOnlineOperadorVisitaTecnicaService.getVisitaImprodutivaPorOperador(
          this.usuario.almope,
          this.tipoPerfil
        )
        this.visitas = result
    ...
    created() {
      this.loadDadosImprodutivosPorOperador()
    }
  }
</script>
