  ...
  <v-container>
    ...
    >
      ...
      <template v-slot:imagem>
        <img style="height: 9.375rem" src="@/assets/img/geral/index-bf.png" />
      </template>
    </card-app-bar>
    <div class="mt-7">
      <v-row>
        <v-col cols="12">
          <DashDadosSilente
            v-if="dadosVendasSilente.length > 0"
          ...
          <!-- DADOS HISTORICO -->
          <DashDadosHistorico
            v-if="vendasHistorica.length > 0"
            :arrayDados="vendasHistorica"
            :isLoadDataHistory="loadingData"
          />
        </v-col>
      </v-row>
    </div>
...
<script>
  ...
  import DashDadosOnline from '@/pages/operacao/net/serviceToSales/_components/DashDadosOnline.vue'
  import DashDadosSilente from '@/pages/operacao/net/serviceToSales/_components/DashDadosSilente.vue'
  import DashDadosHistorico from '@/pages/operacao/net/serviceToSales/_components/DashDadosHistorico.vue'
