  ...
  export default {
    ...
    methods: {
      loadResultadoOnline() {
        ...
        let urlData = `${config.baseUrl}api/shared/brownfield/coordenador/resultado_online/${this.usuarioAlmope}`
      ...
      loadResultadoHistoricoResidencial() {
        let urlData = `${config.baseUrl}api/shared/brownfield/coordenador/resultado_historico_residencial/${this.usuarioAlmope}`
        this.$api.get(urlData).then(res => {
      ...
      loadResultadoHistoricoMovel() {
        let urlData = `${config.baseUrl}api/shared/brownfield/coordenador/resultado_historico_movel/${this.usuarioAlmope}`
        this.$api.get(urlData).then(res => {
