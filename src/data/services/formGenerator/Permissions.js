...
const FormGeneratorPermissionsService = {
  /**
  ...
  async getAll(id) {
    try {
      const urlData = `${config.baseUrl}api/shared/pyform/form_generator/permissions/get_all/${id}`
  ...
  async insert(data) {
    try {
      ...
      const urlData = `${config.baseUrl}api/shared/pyform/form_generator/permissions/insert`
  ...
  async delete(id, deletedBy) {
    try {
      const urlData = `${config.baseUrl}api/shared/pyform/form_generator/permissions/delete/${id}/${deletedBy}`
  ...
  async restore(id) {
    try {
      const urlData = `${config.baseUrl}api/shared/pyform/form_generator/permissions/restore/${id}`
  ...
  async update(id, data) {
    try {
      ...
      const urlData = `${config.baseUrl}api/shared/pyform/form_generator/permissions/update/${id}`
      const payload = {
  ...
  modelMap: {
    formId: 'FORM_GENERATOR_ID',
    roleId: 'ROLE_ID',
    roleType: 'ROLE_TYPE'
  }
}

export default FormGeneratorPermissionsService
